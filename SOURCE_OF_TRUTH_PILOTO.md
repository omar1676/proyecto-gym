...
| Auditoría del nuevo | No aplica a acciones nuevas | Registra su propio piloto | Nuestro sistema para sus acciones | Actor, tenant, sede, acción, fecha y correlación |

El cambio de la fuente oficial por área durante etapas posteriores permanece
`PENDIENTE`; no se deduce automáticamente por superar una prueba.

## Regla de cambio

Cambiar una fuente de verdad exige acta con: dominio, fecha/hora de corte,
responsable, datos incluidos, conciliación anterior, fallback, comunicación y
criterio de rollback. La decisión puede ser distinta por dominio; no existe un
“cambio total” implícito.
