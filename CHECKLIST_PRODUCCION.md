...
- [PENDIENTE] Rotar las credenciales históricas detectadas en `.git.bak`,
  `.env.produccion.bak` y `recursos/inscripciones.zip`; retirar archivos no
  invalida credenciales.
- [OK] `.env.produccion.bak`, `.git.bak` e `inscripciones.zip` retirados del
