...
$productionOnly = ['SMTP configurado','copia externa configurada','sin backup local de secretos en release','sin repositorio de respaldo en release','sin instalador en release'];
