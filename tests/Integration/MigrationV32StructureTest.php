...
try{
    ...
    check('v32 se ejecuta antes de v33-v36',$manager->migratePending()===['migracion_v32.sql','migracion_v33.sql','migracion_v34.sql','migracion_v35.sql','migracion_v36.sql']);
