...
try {
    ...
    check('verificador separa esquema v27 de actual v28', $before['SCHEMA_AT_BACKUP'] === 27 && $before['CURRENT_SCHEMA'] === 28);
    ...
    check('migración posterior del restore aplica solo v28', $currentManager->migratePending() === ['migracion_v28.sql']);
