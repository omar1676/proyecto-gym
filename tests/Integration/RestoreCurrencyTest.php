...
try {
    ...
    check('verificador separa esquema v27 de actual v29', $before['SCHEMA_AT_BACKUP'] === 27 && $before['CURRENT_SCHEMA'] === 29);
    ...
    check('migración posterior del restore aplica v28 y v29', $currentManager->migratePending() === ['migracion_v28.sql', 'migracion_v29.sql']);
