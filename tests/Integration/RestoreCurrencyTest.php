...
try {
    ...
    check('verificador separa esquema v27 de actual v36', $before['SCHEMA_AT_BACKUP'] === 27 && $before['CURRENT_SCHEMA'] === 36);
    ...
    check('migración posterior del restore aplica v28-v36', $currentManager->migratePending() === ['migracion_v28.sql', 'migracion_v29.sql', 'migracion_v30.sql', 'migracion_v31.sql', 'migracion_v32.sql', 'migracion_v33.sql', 'migracion_v34.sql', 'migracion_v35.sql', 'migracion_v36.sql']);
