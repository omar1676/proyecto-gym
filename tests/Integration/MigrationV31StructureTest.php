...
try {
    ...
    check('v31 y sus migraciones posteriores se ejecutan realmente', $manager->migratePending() === ['migracion_v31.sql','migracion_v32.sql','migracion_v33.sql','migracion_v34.sql','migracion_v35.sql']);
    ...
    check('segunda ejecución no reaplica v31-v35', $manager->migratePending() === []);
