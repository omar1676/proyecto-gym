...
try {
    ...
    check('baseline v21 solo registra hasta v22', $afterBaseline['pending'] === [
        'migracion_v23.sql', 'migracion_v24.sql', 'migracion_v25.sql', 'migracion_v26.sql', 'migracion_v27.sql', 'migracion_v28.sql', 'migracion_v29.sql', 'migracion_v30.sql', 'migracion_v31.sql',
    ]);
    ...
    check('v23-v31 se ejecutan realmente y en orden', $applied === [
        'migracion_v23.sql', 'migracion_v24.sql', 'migracion_v25.sql', 'migracion_v26.sql', 'migracion_v27.sql', 'migracion_v28.sql', 'migracion_v29.sql', 'migracion_v30.sql', 'migracion_v31.sql',
    ]);
    foreach ([
