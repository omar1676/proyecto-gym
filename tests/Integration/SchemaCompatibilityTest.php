...
try {
    ...
    check('release actual acepta esquema actual', $current['current'] === 30);
    ...
    check('release anterior declarada compatible acepta esquema actual', SchemaCompatibility::assertRuntime($db, $temp)['current'] === 30);
