...
try {
    ...
    check('v33 se ejecuta realmente antes de v34', $manager->migratePending() === ['migracion_v33.sql','migracion_v34.sql']);
    $tables = [
    ...
    check('v33 y v34 no se reaplican', $manager->migratePending() === []);
