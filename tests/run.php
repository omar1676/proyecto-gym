...
$php = PHP_BINARY;
$suites = [
    'Unit' => ['tests/Unit/ValidationTest.php', 'tests/Unit/MailerTest.php', 'tests/Unit/CsvImportReaderTest.php', 'tests/Unit/AccessDecisionTest.php', 'tests/Unit/MockAccessControlProviderTest.php', 'tests/Unit/BackupStorageTest.php'],
    'Integration' => ['tests/Integration/IntegrityTest.php', 'tests/Integration/IdempotencyTest.php', 'tests/Integration/ConcurrencyStockTest.php', 'tests/Integration/SociosPaginationTest.php', 'tests/Integration/MigrationImportTest.php', 'tests/Integration/MigrationResumeTest.php', 'tests/Integration/MigrationDuplicateTest.php', 'tests/Integration/EconomicModelTest.php', 'tests/Integration/CashTest.php', 'tests/Integration/CashConcurrencyTest.php', 'tests/Integration/AccessControlSyncTest.php', 'tests/Integration/SecondGymGeneralizationTest.php'],
    'Security' => ['tests/Security/OutputEncodingTest.php', 'tests/Security/RateLimitTest.php', 'tests/Security/MigrationSecurityTest.php', 'tests/Security/EconomicIsolationTest.php', 'tests/Security/AccessControlIsolationTest.php', 'tests/Security/StagingSafetyTest.php', 'pruebas/multiempresa.php', 'pruebas/multisede.php', 'pruebas/autorizacion.php'],
