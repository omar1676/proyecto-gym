...
$suites = [
    ...
    'Security' => ['tests/Security/OutputEncodingTest.php', 'tests/Security/RateLimitTest.php', 'tests/Security/MigrationSecurityTest.php', 'tests/Security/EconomicIsolationTest.php', 'tests/Security/AccessControlIsolationTest.php', 'pruebas/multiempresa.php', 'pruebas/multisede.php', 'pruebas/autorizacion.php'],
