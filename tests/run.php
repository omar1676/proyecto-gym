...
$php = PHP_BINARY;
$suites = [
    'Unit' => ['tests/Unit/ValidationTest.php', 'tests/Unit/MailerTest.php', 'tests/Unit/CsvImportReaderTest.php', 'tests/Unit/AccessDecisionTest.php', 'tests/Unit/MockAccessControlProviderTest.php'],
