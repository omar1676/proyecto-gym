...
<section class="mx-auto max-w-6xl">
    ...
    <div class="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
        ...
        <article class="rounded-2xl border bg-white p-5"><p class="text-xs font-bold uppercase text-neutral-500">Fallos de sincronización</p><p class="mt-2 text-3xl font-extrabold"><?= (int)$metrics['sync']['FAILED'] ?></p><p class="text-xs text-neutral-500">Provider actual: <?= htmlspecialchars(defined('ACCESS_CONTROL_MODE') ? ACCESS_CONTROL_MODE : 'disabled',ENT_QUOTES,'UTF-8') ?></p></article>
    </div>
